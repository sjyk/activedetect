"""
Detects Char Errors in a dataset
"""
...
class CharSimilarityErrorModule(ErrorModule):
	...
	def predict(self, strings):
		...
		chars = [[c for c in s] for s in strings]
	...
	def desc(self):
		return "A character was found that was not well predicted by a sequential module thresh= " + str(self.thresh)
