...
class EvaluateCleaning(object):
    ...
    def __init__(self, full_features, full_labels, model):
        ...
        self.train_indices, self.test_indices = train_test_split(range(0, len(self.full_labels)), test_size=0.2)
    ...
    def run(self, detector, training_action, test_action):
        ...
        return accuracy_score(self.test_labels, ypred), f1_score(self.test_labels, ypred)
